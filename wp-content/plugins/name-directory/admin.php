    ...
    if(! empty($_POST['mode']) && ! empty($_POST['dir_id']) && check_admin_referer( 'name_directory_dirmanagement','name_directory_adminnonce' ))
    {
        $wpdb->update(
            ...
            array(
                ...
                'show_character_header'   => $_POST['show_character_header'],
    ...
    <form name="add_name" method="post" action="<?php echo $wp_url_path; ?>">
        <table class="wp-list-table widefat" cellpadding="0">
            ...
            <tr>
                ...
                <td width="70%"><input type="text" name="name" value="<?php echo (! empty($directory['name']) ? $directory['name'] : ''); ?>" size="20" class="name_directory_widest"></td>
            </tr>
            <tr>
                <td><?php echo __('Description', 'name-directory'); ?><br><small><?php echo __('Just for your own administration, it does not show on the front-end', 'name-directory'); ?></small></td>
                <td><textarea name="description" rows="5"  class="name_directory_widest"><?php echo (! empty($directory['description']) ? $directory['description'] : ''); ?></textarea></td>
            </tr>
        ...
        foreach($csv as $entry)
        {
            ...
            $db_res = $wpdb->insert(
                ...
                array(
                    ...
                    'description'   => ! empty($prepared_row['description']) ? $prepared_row['description'] : '',
